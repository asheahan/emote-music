  ...
  methods: {
    ...
    drawChart() {
      ...
      this.svg = d3
        .select(this.$el)
        .append('svg')
        .attr('width', this.options.w + this.options.margin.left + this.options.margin.right)
        .attr('height', this.options.h + this.options.margin.top + this.options.margin.bottom)
        .attr('class', 'radar');
